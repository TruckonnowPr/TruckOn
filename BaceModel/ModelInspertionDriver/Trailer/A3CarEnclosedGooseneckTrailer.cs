...
{
    public class A3CarEnclosedGooseneckTrailer : ITransportVehicle
    {
        public int CountPhoto { get; set; } = 15;
        public string Type { get; set; } = "A3CarEnclosedGooseneckTrailer";
        ...
        public A3CarEnclosedGooseneckTrailer()
        {
