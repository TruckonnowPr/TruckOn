...
{
    public class Bumperpool1CarEnclosedTrailer : ITransportVehicle
    {
        public int CountPhoto { get; set; } = 18;
        public string Type { get; set; } = "Bumperpool1CarEnclosedTrailer";
        ...
        public Bumperpool1CarEnclosedTrailer()
        {
