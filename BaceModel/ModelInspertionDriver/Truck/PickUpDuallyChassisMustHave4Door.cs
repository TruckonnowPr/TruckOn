...
{
    public class PickUpDuallyChassisMustHave4Door : ITransportVehicle
    {
        public int CountPhoto { get; set; } = 19;
        public string Type { get; set; } = "PickUpDuallyChassisMustHave4Door";
        ...
        public PickUpDuallyChassisMustHave4Door()
        {
